...
// const genAI = new GoogleGenerativeAI('AIzaSyBg9EbHHtqXT4ghmxJ8Q9ofssZADlgskNo');

// // simple similarity (cosine approx using keyword match)
// function scoreChunk(chunk, query) {
...
//       .map((chunk) => ({
//         chunk,
//         score: scoreChunk(chunk, message),
//       }))
//       .sort((a, b) => b.score - a.score);
...
//     const prompt = `
// You are Vansh Sandhir's AI assistant.
